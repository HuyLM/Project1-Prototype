...
namespace Lean.Touch
{
	...
	public class LeanSelectableDrop : LeanSelectableByFingerBehaviour
	{
		...
		[System.Serializable] public class IDropFailedEvent : UnityEvent {}
        ...
        /// <summary>Called on the first frame the conditions are met.
        /// GameObject1 = The GameObject instan1ce this was 1 on.</summary>
        public IDropFailedEvent OnDropFailed { get { if (onDropFailed == null) onDropFailed = new IDropFailedEvent(); return onDropFailed; } } [SerializeField] private IDropFailedEvent onDropFailed;
...
namespace Lean.Touch.Editor
{
	...
	public class LeanSelectableDrop_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			...
			var usedC = Any(tgts, t => t.OnDropFailed.GetPersistentEventCount() > 0);
